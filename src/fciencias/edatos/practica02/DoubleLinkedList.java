...
public class DoubleLinkedList<T> implements TDAList<T> {
    ...
    public Iterator listIterador(){
    	return new Iterador();//iterador para recorrer la lista
    }
 ...
 */
   ...
   if(longitud==1) clear();
    ...
    public boolean contains(T elemento)  {
       ...
       if(buscaNodo(elemento) != null || buscaNodoAtras(elemento) != null){//recorre y compara desde el rabo y la cabeza
